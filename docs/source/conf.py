...
# -*- coding: utf-8 -*-
#
# Pyforms Terminal documentation build configuration file, created by
...
html_logo = '_static/imgs/pyforms-terminal-small.jpg'
...
htmlhelp_basename = 'PyformsTerminaldoc'
...
latex_documents = [
    (master_doc, 'PyformsTerminal.tex', 'Pyforms Terminal Documentation',
...
man_pages = [
    (master_doc, 'pyformsweb', 'Pyforms Terminal Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyformsTerminal', 'Pyforms Terminal Documentation',
     author, 'PyformsTerminal', 'One line description of project.',
     'Miscellaneous'),
]
